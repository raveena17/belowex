...
class EmployeeRegistrationTest(TestCase):
    ...
    def test_success_data(self):
        response = self.client.post('/mymail/add_employee/', {
            'name': 'Raveena',
...
class TemplateTest(TestCase):
    ...
    def test_template(self):
        self.assertTemplateUsed('mymail/birthday_list.html')
        self.assertTemplateUsed(template_name='birthday_list.html')
        self.assertTemplateUsed('mymail/employee_details.html')
        self.assertTemplateNotUsed('mymail/index.html')
...
#         response = self.client.get('/mymail/add_employee/')
