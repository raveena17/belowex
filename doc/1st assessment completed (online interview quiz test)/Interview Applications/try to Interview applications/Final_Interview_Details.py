...
class Language:
    ...
    def PythonQuestions(self):
        ...
        tkMessageBox.showinfo(title="Greetings", message="Start the Python Questions")
    ...
    def JavaQuestions(self):
        ...
        tkMessageBox.showinfo(title="Greetings", message="Start the Java Questions!")
...
k=Mainfunction()   #another class create a object
